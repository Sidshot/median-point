...
import { g as renderElement, h as generateCspDigest, s as spreadAttributes, u as unescapeHTML, c as renderTemplate, j as removeBase, i as isRemotePath, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, k as createHeadAndContent, r as renderComponent } from './entrypoint_4te5mXyS.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DAwPv8qh.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Cg9oCcv_.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_akLyFbc7.mjs');
